# TER_FCA_Notebook
Ce répertoire git est destiné à regrouper les documents de notre TER de M1 informatique. Le sujet de notre TER était : *FCA Notebook* ou *pratiquer l'analyse formelle de concepts dans un notebook*. Nous avons donc à disposition les répertoires suivants :
